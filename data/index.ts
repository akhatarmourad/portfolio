export const gridItems = [
    ...
    },
    {
      ...
      className: "bg-gradient-to-r from-black-200 via-slate-800 to-black-200 border border-slate-800",
      imgClassName: "",
      titleClassName: "justify-start",
      img: "./grid.svg",
      spareImg: "./b4.svg",
    ...
    },
    {
      ...
      description: "Specializes in online marketing strategies and tools.",
      className: "md:col-span-2 md:row-span-2 bg-gradient-to-r from-black-200 via-blue-950 to-black-200 border border-blue-950",
    ...
    },
    {
      ...
      title: "Digital Marketing Specialist",
      description: "Specializes in online marketing strategies and tools.",
      className: "bg-gradient-to-r from-black-200 via-blue-950 to-black-200 border border-blue-950",
      imgClassName: "",
